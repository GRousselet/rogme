#' #' Plot shift function generated by \code{\link{shifthd}} or \code{\link{shiftdhd}}
#' #'
#' #' Plot one or more shift functions using deciles, as generated by \code{\link{shifthd}} or
#' #' \code{\link{shiftdhd}}. The function returns a list of ggplot objects, which can be
#' #' customised using the \href{http://docs.ggplot2.org/current/}{ggplot2} package.
#' #'
...
#' #'   }
#' #'
#' #' @param data A list of data frames generated by \code{\link{shifthd}} or \code{\link{shiftdhd}}.
